                ...
                if(caught.nervous){
                    if(caught.nervous.isScared()){
                        if(caught.confused){
                            ...
                            d.chyron = "CIRCULO TEME CUADRADOS";
                        }else{
...
var _manifesto = [
    ...
    "LA AUDIENCIA SABE LO QUE QUIERE"
];
...
function _chyAngry(d){
    ...
    if(caught.angry.length>0){
        ...
        if(caught.angryCircleShouting.length+caught.angrySquareShouting.length>0){
            ...
            if(angryRatio>=1){
                d.chyron = "TODO EL MUNDO SE ODIA";
            }else if(angryRatio>=0.75){
                d.chyron = "CASI TODO EL MUNDO SE ODIA";
            }else{
                ...
                if(caught.angryCircleShouting.length==0){
                    d.chyron = "CUADRADOS ODIAN CIRCULOS"; // must be a square
                }else{
                    d.chyron = "CIRCULOS ODIAN CUADRADOS"; // must be a circle, or both
                }
...
function _chyHelping(d){
    ...
    if(caught.helping){
        if(caught.helping.hasHelped){
            ...
            d.chyron = "a nadie le importan estos dos";
        }
        return true;
    }
    return false;
